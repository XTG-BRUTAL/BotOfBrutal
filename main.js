...
console.log(color(`${spc4}< ================================================== >`, 'cyan'))
    ...
    console.log(color('[DOGE BOT]'), color('BOT OF BRUTAL 𝗜𝘀 𝗢𝗻𝗹𝗶𝗻𝗲 ㋛︎', 'aqua'))
